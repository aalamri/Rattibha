 ...
 * request this Node process handles. For an app without per-request
 * personalization beyond the language toggle, that's an accepted
 * trade-off — a high-traffic, fully request-isolated setup would want a
 * scoped instance per request instead.
 */
